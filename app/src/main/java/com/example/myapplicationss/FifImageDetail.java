...
public class FifImageDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fif_image_detail);
        ...
        add5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent ob09 = new Intent(getApplicationContext(),Product.class);
                startActivity(ob09);
