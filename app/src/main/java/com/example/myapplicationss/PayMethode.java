...
public class PayMethode extends AppCompatActivity {
    //declare  text View and button components
    TextView tte;
    Button  pm2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pay_methode);
         //get Ids of the text View and button
        tte=(TextView) findViewById(R.id.tte);
        pm2=(Button) findViewById(R.id.pm2);
        //by clicking the button action will happened
        pm2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //by licking the button will go to OrderSuccessful page
                Intent nti = new Intent(getApplicationContext(),OrderSuccessful.class);
                startActivity(nti);
