...
public class ForteenImageDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forteen_image_detail);
        //get the Ids of the ImageView, textView and Button
        ivpd14=(ImageView) findViewById(R.id.ivpd14);
        t14=(TextView) findViewById(R.id.t14) ;
        tv14=(TextView) findViewById(R.id.tv14) ;
        add14=(Button) findViewById(R.id.add14);
        //add action to add14 button
        add14.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //by clicking the button will go to Product page
                Intent ob5 = new Intent(getApplicationContext(),Product.class);
                startActivity(ob5);
            }
        });
    }
