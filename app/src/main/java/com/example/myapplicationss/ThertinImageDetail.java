...
public class ThertinImageDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thertin_image_detail);
        ...
        add13=(Button) findViewById(R.id.add13);
        //add action to add13 button
        add13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //by clicking the button will go to Product page
                Intent ob22 = new Intent(getApplicationContext(),Product.class);
                startActivity(ob22);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.lo:
                ...
                startActivity(lout); //toast message will appear by clicking this item
