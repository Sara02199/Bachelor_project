...
public class TwImageDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tw_image_detail);
        ive =(ImageView) findViewById(R.id.ive);
        //get the Ids of the ImageView, textView and Button
        t8=(TextView) findViewById(R.id.t8) ;
        tvew9=(TextView) findViewById(R.id.tvew9) ;
        add12=(Button) findViewById(R.id.add12);
        //add action to add12 button
        add12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //by clicking the button will go to Product page
                Intent ob = new Intent(getApplicationContext(),Product.class);
                startActivity(ob);
