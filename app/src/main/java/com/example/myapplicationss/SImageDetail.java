...
public class SImageDetail extends AppCompatActivity {
    //declare  Image View, text View and Button components
    ImageView ivpr;
    TextView tvinfo2, tvpprice02;
    Button add2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_simage_detail);
        //get the Ids of the ImageView, textView and Button
        ivpr =(ImageView) findViewById(R.id.ivpr);
        tvinfo2=(TextView) findViewById(R.id.tvinfo2) ;
        tvpprice02=(TextView) findViewById(R.id.tvpprice02) ;
        add2=(Button) findViewById(R.id.add2);
        //add action to add2 button
        add2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //by clicking the button will go to Product page
                Intent ob3 = new Intent(getApplicationContext(),Product.class);
                startActivity(ob3);
